...
dev.off() 
```
# Vocal activity is significantly higher in dawn than dusk in both sociality categories.

![% acoustic detections at dawn across categories of sociality](figs/fig_percentDetections_vs_sociality.png) 
