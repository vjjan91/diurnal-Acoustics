...
ggsave(fig_freq_vocAct, filename = "figs/fig_peakFrequency_vs_dawnDetections_regressions.png", width = 14, height = 16, device = png(), units = "in", dpi = 300)
dev.off() 
```

![No significant relationship was observed between % acoustic detections at dawn and median peak frequency.](figs/fig_peakFrequency_vs_dawnDetections_regressions.png)
## Correlative analysis

```{r}
fig_corr_freq_vocAct <- ggscatterstats(
                         data = dawn,
                         x = log_freq,
                         y = percent_normalized_detections,
...
ggsave(fig_corr_freq_vocAct, filename = "figs/fig_peakFrequency_vs_dawnDetections_correlations.png", width = 14, height = 16, device = png(), units = "in", dpi = 300)
dev.off() 
```

![No significant relationship was observed between % acoustic detections at dawn and median peak frequency.](figs/fig_peakFrequency_vs_dawnDetections_correlations.png)
