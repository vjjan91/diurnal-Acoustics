...
vocal_act$plot_percent <- ifelse(vocal_act$time_of_day == "dusk",
...
```{r, echo = FALSE, fig.cap= "Species-specific vocal activity differences between dawn and dusk"}
knitr::include_graphics("figs/fig_percentDetections_species.png")
```
...
ggplot.component = list(theme(text = element_text(family = "Century Gothic", size = 10, face = "bold"),plot.title = element_text(family = "Century Gothic",
      size = 15, face = "bold"),
      plot.subtitle = element_text(family = "Century Gothic", 
      size = 15, face = "bold",color="#1b2838"),
      axis.title = element_text(family = "Century Gothic",
...
```{r, echo= FALSE, fig.cap= "Across the entire community, higher vocal activity was detected at dawn compared to dusk"}
knitr::include_graphics("figs/fig_percentDetections_overall.png")
```
...
```{r, echo=FALSE, fig.cap= "(a) Vocal activity was significantly higher at dawn compared to dusk across a tropical bird community in the Western Ghats. (b) Species-specific vocal activity across dawn and dusk."}
knitr::include_graphics("figs/fig01.png")
```
