...
# figure of perecent detections
fig_percent_detections <- ggplot(vocal_act, aes(x = eBird_codes,
                               y = plot_percent,
                               fill = time_of_day)) +
...
ggsave(fig_percent_detections, filename = "figs/fig_percentDetections_species.png", width = 13, height = 20, device = png(), units = "in", dpi = 300)
dev.off() 
```

```{r, fig.cap= "% acoustic detections for each species between dawn and dusk"}
knitr::include_graphics("figs/fig_percent_detections_species.png")
```
