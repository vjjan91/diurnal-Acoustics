...
```{r, echo = FALSE, fig.cap= "Weakly territorial species were significantly more dawn shifted than non-territorial species at dawn."}
knitr::include_graphics("figs/fig_percentDetections_territoriality.png")
```
