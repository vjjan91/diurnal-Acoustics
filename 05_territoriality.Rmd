...
fig_terr_vocAct <- vocal_act %>% mutate(territory_cat = fct_relevel(territory_cat, 
...
dev.off() 
```
# There are significant differences in vocal activity of highly territorial, weakly territorial and non-territorial species between dawn and dusk. Vocal activity is significantly higher in dawn than dusk among all territorial categories. 
