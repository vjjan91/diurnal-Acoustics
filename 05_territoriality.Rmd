...
## Extracting territoriality data from Tobias et al. 2016 dataset
```{r}
...
#There are significant differences (p = 0.039) in % acoustic detections between weakly and non-territorial species in dawn. No other significant differences seen. 
