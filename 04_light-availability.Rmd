...
# No significant differences were observed between the slopes across dawn and dusk. Here the slope conveys the relationship between the number of acoustic detections and timing of vocalization
...
for(i in 1:length(unique(acoustic_data$common_name))) {
  ...
  geom_text(aes(label = ifelse(percent_normalized_detections > 0,
