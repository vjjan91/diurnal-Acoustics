...
```{r, echo = FALSE, fig.cap= "No differences in vocal activity  between communal signallers and non-communal signallers at dawn."}
knitr::include_graphics("figs/fig_percentDetections_vs_sociality.png")
```
...
```{r, echo = FALSE, fig.cap= "(a) Weakly territorial species were significantly more dawn shifted than non-territorial species. (b) No differences in vocal activity  between communal signallers and non-communal signallers."}
knitr::include_graphics("figs/fig04.png")
```
