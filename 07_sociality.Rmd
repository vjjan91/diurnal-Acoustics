...
fig1 <- fig_terr_vocAct + fig_soc_vocAct
ggsave(fig1, filename = "figs/fig_percentDetections_territoriality_sociality.png", width = 16, height = 14, device = png(), units = "in", dpi = 300)
dev.off() 
```
