...
No significant differences in percent detections across categories between dawn and dusk.
...
ggsave(fig_trophicNiche_vocAct, filename = "figs/fig_percentDetections_trophicNiche.png", width = 14, height = 16, device = png(), units = "in", dpi = 300)
dev.off() 
```
