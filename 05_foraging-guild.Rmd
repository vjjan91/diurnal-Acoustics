...
ggsave(fig_trophicNiche_vocAct, filename = "figs/fig_percentDetections_foragingGuild.png", width = 16, height = 14, device = png(), units = "in", dpi = 300)
dev.off() 
```

```{r, echo = FALSE, fig.cap= "We found significant differences in the dawn vocal activity between invertivore and frugivore species and omnivore and frugivore species."}
knitr::include_graphics("figs/fig_percentDetections_foragingGuild.png")
```
