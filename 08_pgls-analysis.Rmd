...
anova(model)
summary(model) # AIC = 463.691
pgls_plot <- plot_model (model, show.values = TRUE, value.offset = 0.3, show.p = TRUE, order.terms = c(7, 6, 5, 4, 3, 2, 1), axis.labels = c('Light availability (Median time to darkness)', 'Territoriality (Highly territorial)', 'Territoriality (Weakly territorial)', 'Sociality (Communal signallers)', 'Median Peak frequency', 'Trophic guild (Invertivore)', 'Trophic guild (Omnivore)'), title = "", dot.size = 3, line.size = 1, value.size = 6) +
  ...
  scale_color_manual (values = c("#0072B2", "#009E73")) #using colour-blind friendly colours
